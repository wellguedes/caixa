    ...
    <div id="conteudo-box">
      <div id="conteudo-box-in"> <a name="skip-menu"></a>
        ...
        <div class="div_centro">
          <div id="content">
            <div class="innercont">
		<div class="titulo">Detalhamento</div>
                <p>
		...
		<td>
                ...
                <p>
                 ...
                 <input type="text" name="data1" size="11" maxlength="10" id="data1" />
                </p>
            <p>
            <label>
                Caixa:
                ...
                <select name="ordem" id="ordem" class="select" style="padding:3px; margin-bottom:10px;border-style:solid;border-width:2;border-color:#7AC6E7; ">
                ...
                <div style="text-align:left"><input name="buscaDados" type="submit" id="buscaDados" value="Buscar" style="height:30px; cursor: pointer; margin:2px"/></div>
                  ...
                  <p>
                      <form name="form1" action="relDetalhado.php" method="post">
                    <a href="cad/relDetalhado.php">Exportar para Excel</a>
                    </form>
                  </p>
