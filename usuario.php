		...
		<div class="titulo">Categorias</div>
              ...
              <form class="jNice" name="menu" method="get">
                <fieldset style="padding:20px; border:1px solid #e1e1e1; margin:0px 0px 10px 0px">
                  <legend style="padding:10px; background-color:#f5f5f5; border:1px solid #e1e1e1; margin: 0px 0px 10px 0px">Administrar Usuários</legend>
                  <hr />
            ...
            echo "#E6E7E9" ?>">
              ...
              <td><?php echo $usua_permissao == 1 ? 'Administração' : 'Recepção'; ?></td>
...
<div id="dialog" title="Cadastro de Usuários">
